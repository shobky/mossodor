import { ArrowRight, ChevronRightIcon, ChevronUpIcon, Sparkles } from "lucide-react";
  ...
  return (
    <Section>
      <div className="xl:min-h-[80vh] w-full sm:w-[80%] lg:w-[60%] 2xl:w-[45%] flex flex-col  items-center space-y-4">
        ...
        <Link href="/" className=" font-medium flex items-center gap-1  text-muted-foreground">Continue Shopping <ChevronRightIcon size={18} className="relative top-[.8px]"/></Link>
      </div>
    </Section>
  );
}
