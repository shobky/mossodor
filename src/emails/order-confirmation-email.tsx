      ...
      <Container style={container}>
        <Section style={message}>
          <Img
            ...
            style={{ margin: "auto" }}
          />
          <Heading style={global.heading}>Your order has been placed.</Heading>
          <Text style={global.text}>
            Tracking information will be available soon once your order is out
            for delievry.
          </Text>
          <Text style={{ ...global.text, marginTop: 24 }}>
            Your payment for {parseFloat(String(order.total / 100)).toFixed(2)}{" "}
            was successful. For payment details, please visit your{" "}
